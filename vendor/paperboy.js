...
exports.streamFile = function (filepath, headerFields, stat, res, req, emitter) {
  ...
  process.nextTick( function() {
    ...
    if(req.headers['if-none-match'] == etag){
	  ...
	  console.log('before stat code')
      statCode = 200;
	  console.log('after stat code')
  ...
  var
    ...
    delegate = {
      error: function (callback) {
		console.log('e'+typeof(callback));
        errorCallback = callback;
        return delegate;
      },
      before: function (callback) {
		console.log('b'+typeof(callback));
        beforeCallback = callback;
        return delegate;
      },
      after: function (callback) {
	    console.log('a'+typeof(callback));
        afterCallback = callback;
        return delegate;
      },
      otherwise: function (callback) {
		console.log('o'+typeof(callback));
